...
class PartiallyApprovedButExtraFundingSupportRequestsReadModelTest : BaseIntegrationTest() {
    ...
    fun `support requests - partially approved but extra funding`() {
        ...
        awaitUntilAsserted {
            val actualReadModel = queryGateway.query(GetAllSupportRequests(), SupportRequestsReadModel::class.java).join()

            assertThat(actualReadModel).isNotNull
